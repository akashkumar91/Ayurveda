                                    ...
                                    <div class="card-body">
                                        <form action="Login_register.php" method="post" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="email" placeholder="name@example.com" name="email" autocomplete="off" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary" href="#" name="btnlogin">Login</button>
                                            </div>
                                        </form>
                                    </div>
